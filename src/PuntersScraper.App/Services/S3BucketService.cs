...
public static class S3BucketService
{
    ...
    /// <summary>Uploads a local file into the configured S3Folder — same convention as
    /// <see cref="S3JsonUploader"/>'s uploads, just for arbitrary local files picked by hand
    /// rather than JSON generated by a scrape. Overwrites an existing object with the same key,
    /// same as any other S3 PutObject.</summary>
