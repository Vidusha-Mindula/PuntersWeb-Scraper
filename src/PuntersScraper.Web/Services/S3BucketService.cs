...
/// <summary>Lists and deletes objects in the configured S3 bucket, for the "Bucket" admin page.
/// Same connection settings (endpoint/keys/bucket) as <see cref="S3JsonUploader"/>, which only
/// ever writes — this is the read/delete counterpart.</summary>
