...
/// nesting — same behavior as the desktop apps' uploader of the same name.</summary>
public static class S3JsonUploader
{
    public static async Task UploadAsync(
        WebAppSettings settings, string fileName, string jsonContent, CancellationToken cancellationToken = default)
    {
